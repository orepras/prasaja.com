...
function constructs(existing, list4) {
  ...
  while (++index < list4.length) {
    ;
    (list4[index].add === "after" ? existing : before).push(list4[index]);
  }
...
function tokenizeAttention(effects, ok2) {
  ...
  function inside(code2) {
    ...
    const open = !after || after === constants.characterGroupPunctuation && before || attentionMarkers.includes(code2);
...
//# sourceMappingURL=chunk-T2OI7LML.js.map
